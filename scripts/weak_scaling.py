...
PARAM_FILE = "../include/include/parameters.prm"
...
def run_weak_scaling():
    ...
    print("Obiettivo: Vedere se il tempo rimane costante aumentando problema e risorse.\n")
    print("Nota: Eseguiamo solo 1 e 4 core perché il raffinamento quadruplica la griglia.")
    ...
    if len(times) > 0:
        t1 = times[0]
        efficiencies = [t1/t for t in times] # Efficiency = Time(1) / Time(N) in weak scaling ideal scenario
